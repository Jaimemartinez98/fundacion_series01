    ...
    <form action="{{ route('empresas.update',$empresa->id) }}" method="POST">
        ...
        <div class="row">
            ...
            <div class="col-3">
                ...
                <input type="text" class="form-control" id="celular_empresa" name="celular_empresa" value="{{$empresa->telefono}}"
            ...
            <div class="col-3">
                ...
                <input type="text" class="form-control" id="correo_empresa" name="correo_empresa" value="{{$empresa->correo_contacto}}"
                    placeholder="Introduzca el NIT de la empresa">
            </div>
